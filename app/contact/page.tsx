...
export const metadata: Metadata = {
  title: 'Contact Us',
  description: 'Contact Evergreen Landscape Design. We\'d love to hear from you about landscape design, maintenance, or requesting a consultation.',
  keywords: ['Contact Evergreen Landscape Design', 'Support', 'Help', 'Get in Touch'],
}
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-8 md:mb-12">
            ...
            <p className="text-base md:text-lg text-gray-600">
              Have questions about landscape design, maintenance, or requesting a consultation? We&#39;d love to hear from you.
            </p>
          </div>
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">info@evergreenlandscapedesign.com</p>
                    <p className="text-gray-600">support@evergreenlandscapedesign.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">(555) 678-9021</p>
