...
export async function generateMetadata(): Promise<Metadata> {
  const title = 'Evergreen Landscapes | Professional Landscaping & Design'
  const description = 'From concept to completion, Evergreen Landscapes creates stunning outdoor environments. Professional landscape design, hardscaping, lawn care, and irrigation services since 1999.'

  return {
    title,
    description,
    keywords: ['Landscaping', 'Landscape Design', 'Hardscaping', 'Lawn Care', 'Irrigation', 'Outdoor Living'],
    openGraph: {
      title,
      description,
      type: 'website',
