...
export const metadata: Metadata = {
  title: 'Services | Evergreen Landscapes',
  description: 'Explore our professional landscaping services including landscape design, hardscaping, lawn care, and irrigation systems.',
}
